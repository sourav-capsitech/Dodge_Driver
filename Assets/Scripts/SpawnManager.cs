...
public class SpawnManager : MonoBehaviour
{
    ...
    private void SpawnCar()
    {
        ...
        // NOTE: Obstacle despawn is now handled by the DestroyOnPass script attached to the car prefab.
    }
    ...
    private void SpawnCoin()
    {
        ...
        // NOTE: Coins are destroyed by the player's collision logic in GameManager.CollectCoin().
        // If they miss a coin, it will still need the DestroyOnPass component to be cleaned up.
    }
